...
export const useWebRTC = (roomId,user)=>{
    ...
    const addNewClient = useCallback(
        (newClient,cb)=>{
            ...
            if(lookingFor === undefined){
                console.log("lookingfor undefined")
                setClients((exisitingClients)=>[ ...exisitingClients,newClient],cb)
            }
        },
        [clients,setClients],
    )
    ...
    useEffect(() => {
        const handleNewPeer = async({peerId,createOffer,user:remoteUser})=>{
            //if already connected then giv warning
